...
const saveCreatorMW = require('../middleware/creator/saveCreatorMW');
...
module.exports = function (app) {
    ...
    //Creator update
    app.use(
        '/creators/add_edit/:creatorid',
        getCreatorByIdMW(objectRepository),
        saveCreatorMW(objectRepository),
        renderMW(objectRepository, 'addeditcreator')
    );
